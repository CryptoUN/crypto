package com.anzusdev.cryptoun.businesslogic.aes;
...
import static com.anzusdev.cryptoun.businesslogic.aes.AES.prepareMessage;
import static com.anzusdev.cryptoun.businesslogic.aes.AuxTransformations.*;
...
public class KeyGenerator {
    ...
    public static List<int[][]> generate(int[] initialKey, AES.Type type) {
    ...
    public static int[] generateInitialKey(AES.Type type) {
    ...
    public static void main(String[] args) {
        ...
        List<int[][]> roundKeys = generate(key, AES.Type.AES128);
